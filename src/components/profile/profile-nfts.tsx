...
export const ProfileNFTs = ({ userAddress, isOwner }: Props) => {
  ...
  const multiSelect = () => {
    return (
      ...
      //   <div
      //     className={twMerge(
      //       'px-4 h-full flex flex-1 justify-center rounded-l-lg items-center bg-zinc-300 dark:bg-neutral-800',
      //       borderColor,
      //       hoverColor,
      ...
      //   <div
      //     className={twMerge(
      //       'px-4 h-full flex flex-1 justify-center items-center bg-zinc-300 dark:bg-neutral-800',
      //       borderColor,
      //       hoverColor,
