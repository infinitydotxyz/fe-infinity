...
export const Trait: FC<Props> = ({ trait, description }) => {
  return (
    <div className="border border-gray-400 rounded-3xl py-5 px-6">
      ...
      <p className="text-center text-sm font-heading font-semibold">{trait.traitValue}</p>
      <p className="text-center text-sm text-theme-light-800 bg-theme-light-300 rounded-3xl py-1 mt-3 font-heading tracking-tighter">
        {description}
      </p>
    </div>
  );
