...
export const ActivityItem: React.FC<ActivityItemPropType> = () => {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-x-4 gap-y-4 bg-gray-50 px-4 sm:px-4 md:px-8 lg:px-16 -mx-1 my-2 sm:my-4 py-2 md:pt-12 md:pb-14 rounded-3xl">
      <div>
