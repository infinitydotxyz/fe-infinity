          ...
          <InputBox label={label} tooltip={tooltip} icon={icon} {...props}>
            <div className="flex items-center w-full">
              ...
              <input
                type={type}
                value={field.value || ''}
                className="p-0 border-none bg-transparent focus:ring-0 block w-full text-base font-heading"
          ...
          <InputBox label={label} tooltip={tooltip}>
            <div className="flex items-center w-full">
              <textarea
                ...
                className="p-0 mt-2 bg-transparent border-none focus:ring-0 block w-full text-base font-heading resize-none"
                placeholder={placeholder}
              />
            </div>
          </InputBox>
