module.exports = {
  ...
  fontFamily: {
    ...
    headingRegular:
      'Monument-Regular,SF UI Display,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol',
