...
export const darkPrimaryBrandColorRgba = 'rgba(200,247,81)';
export const primaryShadow = `shadow-[3px_3px_0px_0px_${primaryBrandColorRgba}] dark:shadow-[2px_2px_0px_0px_${darkPrimaryBrandColorRgba}]`;
